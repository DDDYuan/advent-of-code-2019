...
for orbit in orbitMap:
    (previous, current) = parseOrbit(orbit)
    previousOrbit = findOrbitByName(previous)
    currentOrbit = findOrbitByName(current)
    currentOrbit.previous = previousOrbit
